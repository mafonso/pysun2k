                ...
                write_api.write(bucket, org, [
                    {
                        ...
                        "timestamp": sun2000['system_time'],
                        "tags": {
                            "serial_number": sun2000['sn'],
                            "unit": inverter_unit
                        },
                        "fields": {
                            "pv0_voltage": sun2000['pv']['0']['voltage'],
                            "pv0_current": sun2000['pv']['0']['current'],
                            "pv1_voltage": sun2000['pv']['1']['voltage'],
                            "pv1_current": sun2000['pv']['1']['current'],
                            "input_power": sun2000['total_input_power'],
                            "internal_temperature": sun2000['internal_temperature']
                        }
                    }
                ])
